...
public class GameStartMessage extends MessageContainer {
    ...
    public GameStartMessage(UUID clientId, PlayerController c) {
    ...
    public GameStartMessage(UUID clientId, UUID p1Id, UUID p2Id, String p1Name, String p2Name) {
        this(clientId, p1Id, p2Id, p1Name, p2Name, "");
    }

    public GameStartMessage(UUID clientId, UUID p1Id, UUID p2Id, String p1Name, String p2Name, String debugMessage) {
        super(MessageTypeEnum.GAME_START, clientId, debugMessage);
        this.p1Id = p1Id;
        this.p2Id = p2Id;
        this.p1Name = p1Name;
        this.p2Name = p2Name;
    ...
    public boolean equals(Object obj) {
        ...
        GameStartMessage other = (GameStartMessage) obj;
