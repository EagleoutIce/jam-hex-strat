...
public class SimpleImageRenderer implements IRenderTileData {
    ...
    @Override
    public void render(final Graphics2D g, final Point2D pos, final Tile ignored, RenderHint... hints) {
