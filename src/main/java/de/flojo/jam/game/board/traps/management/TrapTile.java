...
public enum TrapTile {
    ...
    BEAR_TRAP("Bärenfalle", new SimpleImageRenderer("tiles/traps/baerenfalle.png", -110 / 1.42d, -100 / 1.39),
            new SimpleImageRenderer("tiles/traps/baerenfalle_aktiv.png", -110 / 1.42d, -100 / 1.39),
