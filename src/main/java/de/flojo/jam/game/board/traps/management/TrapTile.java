...
public enum TrapTile {
    SPIKE("Stachelfalle", new SimpleImageRenderer("tiles/traps/stachelfalle.png", -279 / 2.15d, -208 / 1.55, .25f),
            new SimpleImageRenderer("tiles/traps/stachelfalle_aktiv.png", -279 / 2.15d, -208 / 1.55, Main.DEFAULT_INTERNAL_SCALE),
            new TrapImprintNodeMap(TrapIdConstants.T_SPIKE, 0, 0)),
    BEAR_TRAP("Bärenfalle", new SimpleImageRenderer("tiles/traps/baerenfalle.png", -499 / 1.42d, -404 / 1.39, .25f),
            new SimpleImageRenderer("tiles/traps/baerenfalle_aktiv.png", -499 / 1.42d, -404 / 1.39, Main.DEFAULT_INTERNAL_SCALE),
