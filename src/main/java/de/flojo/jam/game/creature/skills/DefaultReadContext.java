...
public class DefaultReadContext implements IProvideReadContext {
    private final Board board;
    private final CreatureCollection cCollection;
    private final TrapCollection tCollection;

    public DefaultReadContext(Board board, CreatureCollection cCollection, TrapCollection tCollection) {
        this.board = board;
